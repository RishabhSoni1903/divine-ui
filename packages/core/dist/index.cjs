...
function Input({ variant, className, startAdornment, endAdornment, ...props }) {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "relative flex items-center", children: [
    startAdornment && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: `absolute left-2 flex items-center  text-muted-foreground [&>svg]:pointer-events-none [&>svg]:shrink-0 [&>svg]:size-4`, children: startAdornment }),
    ...
    endAdornment && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: `relative right-6 flex items-center text-muted-foreground [&>svg]:shrink-0 [&>svg]:size-4`, children: endAdornment })
  ] });
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        (tab.count ?? 0) > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "rounded-full bg-gray-300 px-2 py-1 text-xs font-medium", children: tab.count })
      ]
    }
  );
}
function TabGroup({ tabs, activeTab, setActiveTab }) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "w-full flex", children: tabs.map((tab) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    Tab,
    {
      tab,
      activeTab,
...
var DialogPortal = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React21.Children.map(children, (child) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
function Dialog2({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Dialog, { open, onOpenChange, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(DialogPortal, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(DialogOverlay, { className: "fixed inset-0 z-50 bg-black/50 backdrop-blur-sm" }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
      DialogContent,
      {
        ...
        children: [
          (title || description || showCloseButton) && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "flex items-start justify-between px-3 pt-3", children: [
            /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "space-y-1", children: [
              title && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(DialogTitle, { className: "text-lg font-semibold", children: title }),
              description && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(DialogDescription, { className: "text-sm text-gray-500", children: description })
            ] }),
            showCloseButton && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(DialogClose, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { className: "rounded-md p-1 hover:bg-gray-100", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(X, { className: "size-5" }) }) })
          ] }),
          children && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "flex-1 overflow-auto px-3 pt-3", children }),
          footer && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "p-3", children: footer })
        ]
      }
    )
  ] }) });
